export const translations = {
  nl: {
    ...
    services: {
      title: 'Onze Diensten',
      subtitle: 'Uitgebreide schoonmaakoplossingen op maat van uw behoeften',
      residential: {
        title: 'Particuliere Reiniging',
        description: 'Complete huisreiniging inclusief afstoffen, stofzuigen, dweilen en desinfecteren van alle woonruimtes',
        features: ['Grondige reiniging', 'Regelmatig onderhoud', 'Verhuisreiniging']
      },
      commercial: {
        title: 'Zakelijke Reiniging',
        description: 'Professionele kantoor- en bedrijfsruimte reiniging voor een perfecte werkomgeving',
        features: ['Kantoorruimtes', 'Winkels', 'Service na werktijd']
      },
      oneTime: {
        title: 'Eenmalige Reiniging',
        description: 'Perfect voor speciale gelegenheden, evenementen of wanneer u een extra grondige schoonmaak nodig heeft',
        features: ['Evenementvoorbereiding', 'Na renovatie', 'Seizoensreiniging']
      },
      custom: {
  ...
  en: {
    ...
    services: {
      ...
      residential: {
        ...
        description: 'Complete home cleaning including dusting, vacuuming, mopping, and sanitizing all living spaces',
      ...
      commercial: {
        ...
        features: ['Office spaces', 'Retail stores', 'After-hours service']
      },
      oneTime: {
        title: 'One-Time Cleaning',
        description: 'Perfect for special occasions, events, or when you need an extra deep clean',
        features: ['Event preparation', 'Post-renovation', 'Seasonal cleaning']
      },
      custom: {
        title: 'Custom Plans',
